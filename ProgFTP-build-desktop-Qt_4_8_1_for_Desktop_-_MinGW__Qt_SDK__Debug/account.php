    ...
    if($_SESSION['pseudo'] != NULL)
    {
        ...
        elseif($_GET['type'] == 'news')
        {
            if($_SESSION['rang'] == 'superadmin')
            {
                ...
                echo '<div class="row"><div class="span5 offset4"><h1>' . getText1('account.news.title.1') . '</h1></div><div class="span2"><a class="btn btn-primary btn-large" href="project.php">' . getText1('account.news.button.1') . '</a></div></div>';
